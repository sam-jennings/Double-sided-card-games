...
**Variant:** Standard (chain 2, refusal cost 2). Consider Slow Match if teaching stalls.  
**Date:** June 2026
...
1. **"The match-and-turn action is instantly legible."**  
   Prediction: after one demonstrated turn, both parents can play without rules queries about the core action (match a symbol, flip, new target appears).  
...
3. **"Chaining feels like a real decision."**  
   Prediction: at least one player experiences the burn of chaining early and being stuck later, or deliberately holds back a chain for later. The bridge-burning tension is felt.  
   Failure signal: players always chain when possible without hesitation, or never chain because it's unclear they can.

4. **"A 3P game finishes in under 10 minutes."**  
   Prediction: first game ~8–12 minutes (including some teaching mid-play); second game under 8.  
   Failure signal: game drags past 15 minutes, or stalls with cycling.

5. **"Refusal cost 2 hurts enough to drive play, not enough to feel punishing."**  
   Prediction: refusals happen occasionally, feel like a setback but not a death sentence. Players actively try to avoid them.  
   Failure signal: refusals happen so often the well drains instantly and the game feels random, OR refusals never happen (targets are always matchable, no tension).

---

## What to watch

- **First-turn confusion.** Can a player look at their hand and identify a playable card within a few seconds? Or do they struggle to parse double-faced cards?
- **Physical handling.** Do players naturally flip the played card after placing it? Or do they forget the turn step?
- **Well visibility.** Do players look at the well's top card? Does it influence their decisions?
...
1. **Show the deck** (~1 min). Pick up a card, show both faces. "Every card has two symbols, one on each side. There are 9 symbols total and every possible pair appears on exactly one card."
...
- Both parents can play independently by game 2 (no rules reminders needed for the core loop).
- At least one game completes in under 10 minutes.
- The table wants to play a second game without being prompted.
- The announce rule generates at least one moment of social energy (laughter, suspense, or "gotcha").

The session raises a red flag if:
- The core action (match + flip) needs re-explaining after the demo round.
- The game stalls or cycles without ending.
- Players feel they have no meaningful choice (just matching whatever they can).
- The announce rule is unanimously ignored or unanimously disliked.
